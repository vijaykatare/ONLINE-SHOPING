 ...
 */
public class OS_Admin_transactions extends javax.swing.JFrame {
    Connection con;
    ResultSet rs;
    Statement stmt;

    /**
     * Creates new form OS_Admin_transactions
     */
    public OS_Admin_transactions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Txn No.", "User Name", "E-mail", "Purchase Amt", "Discount", "Total Pay Amt", "Transaction Date"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 850, 320));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 30, 370, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {      Class.forName("java.sql.DriverManager");
            ...
            while (rs.next()){
                ...
                ta=rs.getString(6);
                dt=rs.getString(7);
                Object rec[]={tn,un,em,pa,dis,ta,dt};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OS_Admin_transactions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
